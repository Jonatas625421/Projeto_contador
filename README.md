...
Clique 2 vezes em cima do arquivo com ícone do Chrome HTML dentro da pasta
do Projeto, então as telas criadas, serão renderizadas diretamente na tela do seu
navegador.
Após é só clicar nos botões de adição, subtração e reset, para observar o resultado
esperado.
co utilizado:
...
Utilização de tags de títulos
Uso de Divs
Uso de tags de links de página
...
Eventos
Funções
Manipulação de elementos por ID
...
aplicação. Como é o caso do contador numérico.
